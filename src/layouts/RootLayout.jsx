...
function RootLayout() {
  ...
  useEffect(() => {
    ...
    const sectionColors = [
      ...
      { id: 'experience', class: 'cursor-experience', dotClass: 'cursor-dot-experience' },
      { id: 'work', class: 'cursor-work', dotClass: 'cursor-dot-work' },
      { id: 'projects', class: 'cursor-projects', dotClass: 'cursor-dot-projects' },
      { id: 'contact', class: 'cursor-contact', dotClass: 'cursor-dot-contact' }
    ]
    
    // Function to check which section is in view
    const checkSectionInView = () => {
      const sections = sectionColors.map(section => document.getElementById(section.id))
