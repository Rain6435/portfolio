                  ...
                  <div className="row justify-content-center">
                    <div className="col-lg-8">
                      ...
                      <div className="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <span className="badge-custom">Information Architecture</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="row justify-content-center">
                <div className="col-lg-8">
                  <div className="text-center mb-5">
                    <div className="d-inline-flex align-items-center justify-content-center p-3 rounded-circle mb-4" style={{ background: "rgba(139, 92, 246, 0.1)" }}>
                      <i className="bi bi-graph-up fs-1 text-primary"></i>
                    </div>
                    <h2 className="h3 mb-4">Project Coming Soon</h2>
                    <p className="lead">
                      I'm currently designing a data visualization dashboard as part of my SEG3125 course.
                      This project will demonstrate my ability to transform complex data into clear, actionable insights through intuitive interface design.
                    </p>
                  </div>
                  ...
                  <div className="border-top pt-5">
                    ...
                    <p>
                      The analytics dashboard will provide meaningful insights from complex datasets, with a focus on clear data visualization and interactive filtering. Users will be able to customize views, export reports, and identify trends through an intuitive interface.
                    </p>
                      ...
                      <div className="col-md-6">
                        <div className="card h-100 bg-light border-0">
                          <div className="card-body p-4">
                            ...
                            <p className="small mb-3">Dynamic visualizations that respond to user interaction, allowing for deeper exploration of data patterns.</p>
                      ...
                      <div className="col-md-6">
                        <div className="card h-100 bg-light border-0">
                          <div className="card-body p-4">
                            ...
                            <p className="small mb-3">Advanced filtering options that allow users to segment data based on various parameters.</p>
                            <div className="text-center py-3">
                      ...
                      <div className="col-md-6">
                        <div className="card h-100 bg-light border-0">
                          <div className="card-body p-4">
                            ...
                            <p className="small mb-3">Live data streaming capabilities for monitoring metrics as they change in real-time.</p>
                            <div className="text-center py-3">
                      ...
                      <div className="col-md-6">
                        <div className="card h-100 bg-light border-0">
                          <div className="card-body p-4">
                            ...
                            <p className="small mb-3">Functionality to save, export, and schedule reports in various formats.</p>
                            <div className="text-center py-3">
                    ...
                    <div className="text-center mt-5">
                      <p className="mb-4">Check back soon to see the completed project!</p>
