...
const VeterinaryWebsite = () => {
  ...
  const services = [
    {
      ...
      icon: "🏥",
      details:
        "Complete physical examination, vaccination updates, health counseling, and preventive care recommendations. Perfect for new pet owners who want to establish a baseline for their pet's health.",
      included: [
  ...
  const confirmBooking = () => {
    const appointmentType = appointmentData.firstVisit
      ? "New Pet Owner Consultation"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-amber-700 leading-relaxed">
                Gentle, compassionate care for pets and peace of mind for their
                families. We specialize in making first-time pet owners feel
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700 mb-3">
                      We understand the joy and concerns that come with your
                      first pet. Our team provides extra guidance and support to
                    ...
                    >
                      Learn more about our new owner services{" "}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-amber-600 mt-2 max-w-2xl mx-auto">
              Comprehensive veterinary services designed to keep your pets
              healthy and give you peace of mind.
            </p>
          </div>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="text-amber-600 font-bold mb-4 text-center text-lg">
                  {service.id === "wellness"
                    ? `Starting at ${service.newOwnerPrice}`
                    : service.price}
                </div>
                <button
            ...
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-8">
                <h3 className="text-2xl font-bold text-amber-900 mb-4">
                  Dr. Sarah Anderson, DVM
                </h3>
                <p className="text-amber-700 mb-4">
                  "I believe every pet deserves gentle, compassionate care. As
                  someone who has helped thousands of first-time pet owners, I
                  understand the questions and concerns you might have."
                </p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center mb-8">
            ...
            <div className="bg-white bg-opacity-10 rounded-2xl p-6 backdrop-blur-sm">
              ...
              <p className="text-sm text-amber-100 mt-2">
                Extended hours for new clients
              </p>
            </div>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-bold text-amber-900 mb-4">
              Your Pet's First Wellness Visit
            </h1>
            <p className="text-amber-700 text-lg max-w-2xl mx-auto">
              Everything you need to know about your pet's first check-up. We'll
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-amber-700 text-sm">
                We'll greet you and your pet, complete paperwork, and answer any
            ...
            <div className="text-center">
              ...
              <p className="text-amber-700 text-sm">
                Dr. Anderson will perform a thorough but gentle examination,
                explaining each step to help you understand your pet's health.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-amber-700 text-sm">
                We'll create a personalized care plan and answer all your
                questions about nutrition, training, and future care.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-amber-700">
                  Comprehensive first visit designed for new pet owners
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 border border-orange-200 rounded-lg p-4 mb-6">
              ...
              <ul className="text-orange-700 text-sm space-y-1">
                ...
                <li>
                  • Current food sample (if you have questions about nutrition)
                </li>
            ...
            <div className="space-y-4">
              <div className="border-b border-amber-100 pb-4">
                <h3 className="font-semibold text-amber-900 mb-2">
                  How should I prepare my pet for their first visit?
                </h3>
                <p className="text-amber-700 text-sm">
                  Bring them hungry for treats, let them explore the carrier
                  beforehand, and try to stay calm yourself - pets pick up on
                  our emotions!
                </p>
              </div>
              <div className="border-b border-amber-100 pb-4">
                <h3 className="font-semibold text-amber-900 mb-2">
                  What if my pet is anxious or scared?
                </h3>
                <p className="text-amber-700 text-sm">
                  This is completely normal! We use fear-free techniques and can
                  take breaks during the exam. Let us know about your pet's
                  temperament when booking.
                </p>
              </div>
              <div className="border-b border-amber-100 pb-4">
                <h3 className="font-semibold text-amber-900 mb-2">
                  How often should my pet visit?
                </h3>
                <p className="text-amber-700 text-sm">
                  Puppies and kittens need more frequent visits initially. We'll
                  create a personalized schedule based on your pet's age, breed,
                  and health status.
                </p>
              </div>
              <div className="border-b border-amber-100 pb-4">
                ...
                <p className="text-amber-700 text-sm">
                  We'll assess your pet's risk factors and lifestyle to
                  recommend the appropriate vaccination schedule. Core vaccines
                  are essential, others depend on your pet's needs.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-amber-900 mb-2">
                ...
                <p className="text-amber-700 text-sm">
                  Absolutely! We encourage pet parents to stay present. It helps
                  keep your pet calm and allows you to ask questions throughout
                  the process.
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-amber-700 text-sm">
                Immediate confirmation with appointment details and preparation
                guide
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-amber-700 text-sm">
                New pet owner resources and tips sent 2 days before your visit
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-amber-700 text-sm">
                Friendly reminder 24 hours before with any last-minute questions
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-amber-700 text-sm">
                Warm welcome and comprehensive care for you and your pet
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6">
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-amber-700 text-lg max-w-2xl mx-auto">
              Complete all sections below to schedule your appointment. We're
              excited to meet you and your pet!
            </p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 border border-amber-200 shadow-lg">
            ...
            <div className="mt-6">
              <label className="flex items-center gap-2">
                ...
                <span className="text-amber-800 font-semibold">
                  This is our first visit to any veterinarian
                </span>
              </label>
              {appointmentData.firstVisit && (
                <div className="mt-4 p-4 bg-amber-50 rounded-lg border border-amber-200">
                  <p className="text-amber-700 text-sm mb-2">
                    <strong>Welcome!</strong> We're excited to meet you and your
                    pet. We'll take extra time to make sure you both feel
                    comfortable.
                  </p>
                  <p className="text-amber-600 text-xs">
                    ✓ Extended 60-minute appointment automatically included
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="mt-6">
              <label className="block text-amber-800 font-semibold mb-2">
                Tell us about your pet (optional)
              </label>
              <textarea
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200 shadow-lg">
            ...
            {appointmentData.service === "Wellness Check-ups" &&
              !appointmentData.firstVisit && (
                <div className="mt-6">
                  <label className="flex items-center gap-2">
                    <input
                    ...
                    <span className="text-blue-800 font-semibold">
                      I'd like extra time for questions (+$10, 60 minutes total)
                    </span>
                  </label>
                </div>
              )}
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-200 shadow-lg">
            ...
            <div className="space-y-6">
              {availableSlots.map((daySlot) => (
                <div
                  key={daySlot.date}
                  className="border-2 border-green-200 rounded-xl p-6 bg-white shadow-sm"
                >
                  ...
                  {(appointmentData.firstVisit ||
                    ...
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-green-800 mb-3">
                        Extended Appointments (60 minutes)
                      </h4>
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-green-800 mb-3">
                      Standard Appointments (30-45 minutes)
                    </h4>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-8 border border-purple-200 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
          ...
          {/* Summary Section */}
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 border border-amber-200 shadow-lg">
            <h3 className="font-semibold text-amber-900 mb-6 flex items-center gap-2 text-2xl">
            ...
            appointmentData.ownerName ? (
              <div className="text-amber-800 space-y-3 bg-white rounded-xl p-6 border border-amber-200 shadow-sm">
                <p className="text-lg">
                  <strong>Pet:</strong> {appointmentData.petName} (
                  {appointmentData.petType}, {appointmentData.petAge})
                </p>
                <p className="text-lg">
                ...
                <div className="mt-6 p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                  ...
                  <ul className="text-green-700 space-y-2">
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-5 h-5 text-green-600" />
                      New pet owner welcome packet (2 days before visit)
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-5 h-5 text-green-600" />
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-5 h-5 text-green-600" />
                      Warm welcome and comprehensive care on your visit day
                    </li>
                  </ul>
                </div>
              </div>
