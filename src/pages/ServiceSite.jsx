              ...
              <div className="row justify-content-center">
                <div className="col-lg-8">
                  <div className="text-center mb-5">
                    ...
                    <p className="lead">
                      I'm currently working on a service site design for a dental clinic as part of my SEG3125 course.
                      This project will demonstrate my skills in creating user-friendly service websites with a focus on appointment booking, service information, and patient education.
                    </p>
                  </div>
                    ...
                    <div className="row g-4 mb-5">
                      <div className="col-md-6">
                        <div className="d-flex">
                          ...
                          <div>
                            <h4 className="h6 mb-2">Improved User Experience</h4>
                            <p className="small text-muted mb-0">Create an intuitive navigation and information architecture</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="d-flex">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">Implement a seamless appointment scheduling feature</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="d-flex">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">Highlight dental procedures and treatments effectively</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="d-flex">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">Ensure perfect functionality across all devices</p>
                          </div>
                        </div>
                      </div>
                    </div>
