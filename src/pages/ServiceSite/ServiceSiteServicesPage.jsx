          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-700 leading-relaxed max-w-3xl mx-auto mb-8">
                Transparent pricing, expert care, and personalized service for
                your beloved companions. Every procedure includes detailed
                consultation and comprehensive follow-up care.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-200 mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-slate-700">
                Compare our services and pricing to find what's right for your
                pet
              </p>
            </div>
              ...
              {services.map((service) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <div className="text-cyan-700 font-bold text-xl mb-1">
                      {service.price}
                    </div>
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-700">
                Everything you need to know about our veterinary services
              </p>
            </div>
                      ...
                      <div className="mb-8">
                        ...
                        <div className="grid grid-cols-2 gap-6 mb-8">
                          <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-6 rounded-2xl border border-emerald-200">
                            <div className="text-sm font-bold text-emerald-800 uppercase tracking-wide mb-2">
                              Investment
                            </div>
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 lg:p-12 text-white mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-300">
                Multiple ways to book your appointment
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
              {[
                ...
                <div
                  key={index}
                  className="text-center p-8 bg-white bg-opacity-10 rounded-2xl backdrop-blur-sm hover-lift transition-all duration-300"
                >
                  <div className="flex justify-center mb-6">{item.icon}</div>
                  <h3 className="text-2xl font-bold mb-4">{item.title}</h3>
                  <p className="text-lg text-slate-200 whitespace-pre-line mb-4">
                    {item.content}
                  </p>
            ...
            <div className="bg-white bg-opacity-10 rounded-2xl p-8 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  },
                  {
                    day: "Friday",
                    date: "June 7th",
                    times: ["9:30 AM", "11:00 AM", "2:30 PM"],
                  },
                ].map((slot, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      {slot.times.map((time, timeIndex) => (
                        <div
                          key={timeIndex}
                          className="bg-emerald-50 text-emerald-700 text-center py-2 px-4 rounded-lg font-medium"
                        >
                          {time}
                        </div>
                      ))}
              ...
              <div className="text-center mt-8">
                <p className="text-slate-300 mb-4">
                  Click any service above to book these available times
                </p>
                <button
