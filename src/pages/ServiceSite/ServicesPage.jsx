...
const ServicesPage = ({ setCurrentPage, handleBookAppointment, services }) => {
      ...
      <div className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16">
          ...
          <button 
            ...
            className="flex items-center gap-2 text-cyan-700 hover:text-cyan-800 font-semibold mb-8 transition-all duration-300 hover:-translate-x-1 focus-ring rounded-lg px-3 py-2 bg-white shadow-sm"
          >
            ← Back to Home
          </button>
