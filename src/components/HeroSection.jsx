      ...
      <div className="container hero-content">
        <div className="row align-items-center">
          <div className="col-lg-7 text-white">
            ...
            <h1 className="display-3 fw-bold mb-4 reveal reveal-delay-1">
              Mohammed <span className="text-primary-light">Elhasnaoui</span>
            </h1>
            <p className="lead mb-4 reveal reveal-delay-2">
              Web Application Developer crafting elegant digital experiences
              with modern technologies. Currently building innovative tools at
            ...
            <div className="mt-5 d-flex gap-4 reveal reveal-delay-3">
              ...
              <a
                href="https://www.linkedin.com/in/mohammed-elhasnaoui-43b8a42a0"
                target="_blank"
                rel="noreferrer"
                className="text-white text-decoration-none"
              >
